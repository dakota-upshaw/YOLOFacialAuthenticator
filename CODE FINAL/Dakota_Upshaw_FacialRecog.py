...
outputDir = 'C:/Users/Master/Desktop/378FacialRecog/Dakota_Upshaw_FacialRecog/DatasetFINAL/Datacollect'
confidence = 0.8
save =True
debug = False
    ...
    if bboxs:
        for bbox in bboxs:
            ...
            if score > confidence:
                ...
                if wn > 1: wn = 1
                if hn > 1: hn = 1
                print(f"Normalized: {xcn},{ycn}, {wn}, {hn}")
                
                if debug: 
                    listInfo.append(f'{classID} {xcn} {ycn} {wn} {hn}\n {classID} {xc} {yc} {imgW} {imgH} \n {x} {y} {w} {h}')
                else:
                    listInfo.append(f'{classID} {xcn} {ycn} {wn} {hn}\n')
