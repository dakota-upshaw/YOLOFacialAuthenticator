...
outputDir = 'Dakota_Upshaw_FacialRecog/DatasetFINAL/SplitData'
inputDir = 'Dakota_Upshaw_FacialRecog/DatasetFINAL/all'
...
os.makedirs(f"{outputDir}/val/images",exist_ok=True)
os.makedirs(f"{outputDir}/val/labels",exist_ok=True)
...
yamlData = f'path: C:/Users/Master/Desktop/378FacialRecog/Dakota_Upshaw_FacialRecog/DatasetFINAL/SplitData\n\
train: ../train/images\n\
val: ../val/images\n\
test: ../test/images\n\
\n\
